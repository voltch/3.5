...
static bool enable_bluesleep_wl = false;
module_param(enable_bluesleep_wl, bool, 0644);

static bool enable_bcm4359_wl = false;
module_param(enable_bcm4359_wl, bool, 0644);
static bool enable_radio_interface_wl = false;
module_param(enable_radio_interface_wl, bool, 0644);
static bool enable_umts_ipc0_wl = false;
...
static void wakeup_source_activate(struct wakeup_source *ws)
{
	...
	if (!enable_bluesleep_wl && !strcmp(ws->name, "bluedroid_timer"))
		return;

	if (!enable_bcm4359_wl && !strcmp(ws->name, "bcm4359_wake_lock"))
		return;
