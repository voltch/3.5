...
TOOLCHAIN=/home/voltaqe/toolchains/aarch64-linux-gnu-5.3
...
echo "Done."
cp $RDIR/arch/arm64/boot/Image /home/voltaqe/boot7/split_img/boot.img-zImage
cp $RDIR/arch/arm64/boot/dtb.img /home/voltaqe/boot7/split_img/boot.img-dtb
